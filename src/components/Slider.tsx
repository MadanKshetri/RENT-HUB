...
const promotionSlides = [
	{
		...
		buttonText: "Shop Now!",
		image:
			"https://www.satoriadventuresnepal.com/pagegallery/trekking-equipments24.jpg",
	},
	{
		id: "2",
	...
	const renderItem = ({ item, index }) => (
		<View
			style={[
				...
				index < promotionSlides.length - 1
	...
	return (
		<View style={styles.sliderContainer}>
			<FlatList
				...
				horizontal
				snapToInterval={slideVisualWidth + itemSpacing}
				decelerationRate="fast" // Enable snapping to pages
				...
				contentContainerStyle={{
					paddingHorizontal: horizontalContainerPadding,
				}}
			/>
			{/* Pagination Dots */}
...
const styles = StyleSheet.create({
	sliderContainer: {
		backgroundColor: "#FFC107", // Your theme color as background
		borderRadius: 15, // Rounded corners to match slides
		// paddingVertical: 10, // Optional padding top & bottom
	},
	slide: {
	...
	paginationDotActive: {
		backgroundColor: "#FFC107", // Branded orange for active
		width: 10,
		height: 10,
	},
});
